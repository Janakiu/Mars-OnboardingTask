...
namespace SpecflowTests.AcceptenceTest.Add
{
    ...
    public class SkillSteps
    {
        ...
        public void WhenIAddANewSkill()
        {
            ...
            //select skill level
            IWebElement skilllevel = Driver.driver.FindElements(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[3]/div/div[2]/div/div/div[2]/select/option"))[3];
            skilllevel.Click();
