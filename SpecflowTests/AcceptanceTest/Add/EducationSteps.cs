...
namespace SpecflowTests.AcceptanceTest.Add
{
    [Binding]
    public class EducationSteps
    {
        ...
        public void WhenIAddANewEducation()
        {
            ...
            Driver.driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/div/div[1]/div[1]/input")).SendKeys("Nagarjuna University");
            ...
            title.SelectByText("M.A");

            //Add degree 
            Driver.driver.FindElement(By.XPath("//input[@name='degree']")).SendKeys("Arts");

            //Select year
            SelectElement year = new SelectElement(Driver.driver.FindElement(By.XPath("//select[@name='yearOfGraduation']")));
            year.SelectByText("2005");
