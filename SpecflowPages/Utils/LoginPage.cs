  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@name ='email']")).SendKeys("janakiu3@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[contains(@name,'password')]")).SendKeys("w1nner");
            Thread.Sleep(1000);
